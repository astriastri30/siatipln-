        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="/daftaraset">Cetak Kode QR</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12 ">
                    <div class="card">
                                ...
                                <table id="basic-datatables" class="display table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <form action="" name="cetak_count" class="form_qr">
                                            @csrf
                                                <input type="checkbox" name="count_cetak[]" class="count_cetak" value="">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary cetak_button" value="cetak_count" name="cetak_qr"> <i class="fas fa-print"></i> Cetak Kode QR
                            </button>
                        </div>
                        </form>
                    </div>
