                                ...
                                <div class="col-md-8 col-lg-6">
                                    <div class="form-group" id="addUnit">
                                            ...
                                            <input type="text" class="form-control no_seri_asset" style="display: none;" id="no_seri"
                                                name="id_master_jaringan" value="{{ $master_jaringan->id_master_jaringan }}" readonly>
                                            @endforeach
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="tgl_pengecekan" value="{{date('Y-m-d')}}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="nip_petugas"
                                                    name="nip_petugas" value="{{auth()->user()->petugas->nip_petugas}}" required readonly>
                                            </div>
                                ...
                                <div class="col-md-8 col-lg-6">
                                    <div class="form-group" id="addUnit">
                                            <div class="form-group">
                                                ...
                                                @foreach($master_aset_jaringan as $master_jaringan)
                                                <input type="text" class="form-control input_nama_asset" id="nama_master_jaringan"
                                                    name="nama_master_jaringan" value = "{{$master_jaringan->nama_master_jaringan}}" required readonly>
                                            @endforeach
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-success btn-lg" value="" name="modal">Simpan</button>
                                </div>
                            </div> 
                        </form>
                    </div>
